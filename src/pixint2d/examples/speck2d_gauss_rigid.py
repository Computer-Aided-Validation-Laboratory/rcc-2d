"""Render the 32x32 rigid additive-Gaussian study case."""
...
def main() -> None:
    ...
    pattern=AdditiveSpeckles.jittered_lattice(kind="gaussian",speckle_diameter=5.,black_area_fraction=.6,jitter_pdf="gaussian",jitter=.12,seed=3,bounds=(-20.,20.,-20.,20.),gaussian_edge_fraction=.4,tail_sigmas=8.)
    ...
    print(f"Wrote {save_preview(image, 'speck2d_gauss_rigid')}")
