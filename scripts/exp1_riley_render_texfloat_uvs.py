...
OUTPUT_ROOT = exp1_output_dir(psf_output_name("exp1_riley_render_texfloat_psf") if psf_enabled() else "exp1_riley_render_texfloat")
            ...
            for ssaa in get_ssaa_levels():
                    for oversamp in get_texture_oversamples():
                        ...
                        configure_raster_config(
                            config, workers=RILEY_RASTER_THREADS, sub_sample=ssaa,
                        )
