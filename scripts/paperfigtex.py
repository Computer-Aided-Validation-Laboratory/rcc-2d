...
CAPTION_EXP1_FIG3 = (
    ...
    r"output at 8 bits. f64 represents a double precision floating point "
    r"value and u8 is an unsigned 8 bit integer."
)
LABEL_EXP1_FIG3 = "fig:exp1_riley_textures_u8_rmse"
...
LABEL_EXP1_FIG4 = "fig:exp1_riley_textures_u12_rmse"
...
# Experiment 3
CAPTION_EXP3_FIG1 = (
    r"Rigid-body displacement convergence for DIC applied to the Gaussian "
...
CAPTION_EXP3_FIG2 = (
    r"Displacement RMSE convergence: (a) fixed texture oversampling "
...
CAPTION_EXP3_FIG3 = (
    r"Self-convergence displacement RMSE for DIC and the Grid Method applied "
