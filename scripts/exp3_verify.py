...
def main() -> None:
    ...
    checks = [
        ("rigid frame-0 eggbox function parity",
         root / "exp3_gridint2d_render_ssaa_im512x512/plate516_cam512_quad9_rigid/eggbox_ss4_frame00.npy",
         root / "exp3_riley_render_func_im512x512/plate516_cam512_quad9_rigid/eggbox_ss4/image_c00_f00.npy"),
        ("finite-star frame-0 eggbox function parity",
         root / "exp3_gridint2d_render_ssaa_im1020x252/plate260x65_cam256_quad9_chirp/eggbox_ss4_frame00.npy",
         root / "exp3_riley_render_func_im1020x252/plate260x65_cam256_quad9_chirp/eggbox_ss4/image_c00_f00.npy"),
    ]
    ...
    curved = checks[1][1].with_name("eggbox_ss4_frame01.npy")
    ...
    for pattern in ("eggbox", "diskaddsat", "gausscont"):
        ...
        floating = root / "exp3_riley_render_texfloat_im512x512/plate516_cam512_quad9_rigid" / f"{tag}_ss4_os4_nearest_float/image_c00_f00.npy"
        integer = root / "exp3_riley_render_texuint_im512x512/plate516_cam512_quad9_rigid" / f"{tag}_ss4_os4_nearest_uint/image_c00_f00.npy"
