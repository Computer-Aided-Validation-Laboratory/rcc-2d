"""Analyse Exp1 Riley uint-texture PSF renders against bespoke PSF renders."""
...
analysis.RESULTS_DIR_TEX = analysis_output_root("exp1", "riley_texuint_psf")
...
if __name__ == "__main__":
    if not riley_enabled("texuint_psf"):
        print("Experiment 1 Riley texuint PSF analysis disabled by RILEY_RENDER_CASES; skipping.")
    else:
        analysis.main()
